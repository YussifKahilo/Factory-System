...
public class FactorySystem {
    ...
    /**
     * adds user to the system by adding him in the users array list. this
     * method is used when a new employeee sings in the factory and when the
     * manager promotes a worker.
     *
     ...
     * this method is used when the manager fires an employee.
     *
    ...
    /**
     * this method is for making the new user create a password for his account
     * is the system.
     *
     ...
     *
     * @param in a reference of scanner class used it to input phone number
     * value.
     * @return phone number.
     */
    ...
    /**
     * login in to the system by adding the user's id and pass and checks if
     * they are connected. the user will login in.
     *
    ...
    /**
     * checks for the id and the password of a user if it's exist or it's
     * invalid inputs.
     *
    ...
    /**
     * this method to save any changes happens in any part or personal data of
    ...
    /**
     * manager utility where the manager can run or manage the factory and
     * access to its component.
     *
     * @param in reference of scanner class it's used to input the values using
     * it.
