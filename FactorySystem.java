...
public class FactorySystem {
    ...
    public void managerUtility(Scanner in, Manager manager, ArrayList<Worker> workers, ArrayList<SuperVisor> superVisors,
    ...
    public void userUtility(Person user, Manager manager, ArrayList<Worker> workers, ArrayList<SuperVisor> superVisors,
        ...
        if (user instanceof Manager) {
            ...
            SuperVisorUtility(in, USER, storage);
            ...
            SalesManUtility(in, USER, financial, storage);
        }
