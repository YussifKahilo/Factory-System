...
public class SuperVisor extends Employee {
	...
	public void	showWorkersInformation() throws IOException{
		...
		BufferedReader reader = new BufferedReader(new FileReader("WorkersId"));	
	...
	public void showTarget()throws IOException{
		BufferedReader reader = new BufferedReader(new FileReader("Target Of SuperVisor.txt"));
		String line = reader.readLine();
		while (line != null) {
	...
	public int setTargetResult(){
		...
		System.out.println("please enter target result:");
